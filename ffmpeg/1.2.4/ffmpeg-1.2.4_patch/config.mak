...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=arm --target-os=linux --enable-cross-compile --cross-prefix='C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-' --prefix=../jni/libffmpeg --sysroot='C:/android-ndk-r9c/platforms/android-9/arch-arm' --extra-cflags=' -IC:/android-ndk-r9c/platforms/android-9/arch-arm/usr/include -DANDROID  -mthumb ' --extra-ldflags=' -LC:/android-ndk-r9c/platforms/android-9/arch-arm/usr/lib' --disable-debug --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avfilter --enable-decoders --enable-demuxers --enable-encoders --enable-filters --enable-indevs --enable-network --enable-parsers --enable-protocols --enable-swscale --enable-gpl --enable-nonfree --enable-thumb --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-vfp --disable-neon --disable-inline-asm --disable-asm --disable-doc
...
ARCH=c
CC=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -s -f
STRIP=C:/android-ndk-r9c/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=C:/android-ndk-r9c/platforms/android-9/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -IC:/android-ndk-r9c/platforms/android-9/arch-arm/usr/include -DANDROID -mthumb -march=armv5te -std=c99 -fomit-frame-pointer -fPIC -mthumb -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -IC:/android-ndk-r9c/platforms/android-9/arch-arm/usr/include -DANDROID -mthumb -march=armv5te -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -LC:/android-ndk-r9c/platforms/android-9/arch-arm/usr/lib  --sysroot=C:/android-ndk-r9c/platforms/android-9/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
